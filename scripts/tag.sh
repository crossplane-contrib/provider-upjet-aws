...
# config/s3/config_test.go -> (s3 || config || all) && !ignore_autogenerated
"${TAGGER}" --parent-dir "${REPO_ROOT}"/config/cluster/s3/config_test.go --tag-format "(s3 || all) && !ignore_autogenerated" --mode file ${EXTRA_BUILDTAGGER_ARGS}
