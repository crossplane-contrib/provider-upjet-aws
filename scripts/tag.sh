...
# config/rds/config_test.go -> (rds || all) && !ignore_autogenerated
"${TAGGER}" --parent-dir "${REPO_ROOT}"/config/rds/config_test.go --tag-format "(rds || all) && !ignore_autogenerated" --mode file ${EXTRA_BUILDTAGGER_ARGS}
