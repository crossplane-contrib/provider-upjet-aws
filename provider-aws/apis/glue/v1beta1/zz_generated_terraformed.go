...
// GetTerraformResourceType returns Terraform resource type for this PartitionIndex
func (mg *PartitionIndex) GetTerraformResourceType() string {
	return "aws_glue_partition_index"
}

// GetConnectionDetailsMapping for this PartitionIndex
func (tr *PartitionIndex) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this PartitionIndex
func (tr *PartitionIndex) GetObservation() (map[string]interface{}, error) {
	o, err := json.TFParser.Marshal(tr.Status.AtProvider)
	if err != nil {
		return nil, err
	}
...
// SetObservation for this PartitionIndex
func (tr *PartitionIndex) SetObservation(obs map[string]interface{}) error {
	p, err := json.TFParser.Marshal(obs)
	if err != nil {
		return err
	}
...
// GetID returns ID of underlying Terraform resource of this PartitionIndex
func (tr *PartitionIndex) GetID() string {
	if tr.Status.AtProvider.ID == nil {
		return ""
	}
	return *tr.Status.AtProvider.ID
...
// GetParameters of this PartitionIndex
func (tr *PartitionIndex) GetParameters() (map[string]interface{}, error) {
	p, err := json.TFParser.Marshal(tr.Spec.ForProvider)
	if err != nil {
		return nil, err
	}
...
// SetParameters for this PartitionIndex
func (tr *PartitionIndex) SetParameters(params map[string]interface{}) error {
	p, err := json.TFParser.Marshal(params)
	if err != nil {
		return err
	}
...
// LateInitialize this PartitionIndex using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *PartitionIndex) LateInitialize(attrs []byte) (bool, error) {
	params := &PartitionIndexParameters_2{}
	if err := json.TFParser.Unmarshal(attrs, params); err != nil {
		return false, errors.Wrap(err, "failed to unmarshal Terraform state parameters for late-initialization")
	}
	opts := []resource.GenericLateInitializerOption{resource.WithZeroValueJSONOmitEmptyFilter(resource.CNameWildcard)}
...
// GetTerraformSchemaVersion returns the associated Terraform schema version
func (tr *PartitionIndex) GetTerraformSchemaVersion() int {
	return 0
}
