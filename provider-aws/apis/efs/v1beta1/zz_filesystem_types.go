...
type FileSystemObservation struct {
	...
	// The latest known metered size  of data stored in the file system, the value is not the exact size that the file system was at any point in time. See Size In Bytes.
...
type SizeInBytesObservation struct {
	...
	// The latest known metered size  of data stored in the file system.
	Value *float64 `json:"value,omitempty" tf:"value,omitempty"`

	// The latest known metered size  of data stored in the Infrequent Access storage class.
	ValueInIa *float64 `json:"valueInIa,omitempty" tf:"value_in_ia,omitempty"`

	// The latest known metered size  of data stored in the Standard storage class.
