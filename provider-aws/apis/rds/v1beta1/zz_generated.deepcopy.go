...
func (in *ProxyTargetParameters) DeepCopyInto(out *ProxyTargetParameters) {
	*out = *in
	...
	if in.TargetGroupNameRef != nil {
		in, out := &in.TargetGroupNameRef, &out.TargetGroupNameRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.TargetGroupNameSelector != nil {
		in, out := &in.TargetGroupNameSelector, &out.TargetGroupNameSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
