...
type ObjectCopyParameters struct {
	...
	// Copies the object if its entity tag  matches the specified tag.
	// +kubebuilder:validation:Optional
	...
	// Copies the object if its entity tag  is different than the specified ETag.
	// +kubebuilder:validation:Optional
	...
	// Account id of the expected destination bucket owner. If the destination bucket is owned by a different account, the request will fail with an HTTP 403  error.
	// +kubebuilder:validation:Optional
	ExpectedBucketOwner *string `json:"expectedBucketOwner,omitempty" tf:"expected_bucket_owner,omitempty"`

	// Account id of the expected source bucket owner. If the source bucket is owned by a different account, the request will fail with an HTTP 403  error.
	// +kubebuilder:validation:Optional
	...
	// Confirms that the requester knows that they will be charged for the request. Bucket owners need not specify this parameter in their requests. For information about downloading objects from requester pays buckets, see Downloading Objects in Requestor Pays Buckets  in the Amazon S3 Developer Guide. If included, the only valid value is requester.
	// +kubebuilder:validation:Optional
