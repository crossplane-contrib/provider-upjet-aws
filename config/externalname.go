...
var TerraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	"aws_mskconnect_connector": TemplatedStringAsProviderDefinedIdentifier("arn:aws:kafkaconnect:{{ .parameters.region }}:{{ .setup.client_metadata.account_id }}:connector/{{ .parameters.name }}/{{ .external_name }}"),
	...
	"aws_mskconnect_custom_plugin": TemplatedStringAsProviderDefinedIdentifier("arn:aws:kafkaconnect:{{ .parameters.region }}:{{ .setup.client_metadata.account_id }}:custom-plugin/{{ .parameters.name }}/{{ .external_name }}"),
	...
	"aws_mskconnect_worker_configuration": TemplatedStringAsProviderDefinedIdentifier("arn:aws:kafkaconnect:{{ .parameters.region }}:{{ .setup.client_metadata.account_id }}:worker-configuration/{{ .parameters.name }}/{{ .external_name }}"),
