...
var GroupMap = map[string]GroupKindCalculator{
	"aws_alb_listener_certificate":                             ReplaceGroupWords("elbv2", 1),
	"aws_alb_listener_rule":                                    ReplaceGroupWords("elbv2", 1),
	"aws_alb_listener":                                         ReplaceGroupWords("elbv2", 1),
	"aws_alb_target_group_attachment":                          ReplaceGroupWords("elbv2", 1),
	"aws_alb_target_group":                                     ReplaceGroupWords("elbv2", 1),
	...
	"aws_cloudtrail":                                           ReplaceGroupWords("cloudtrail", 1),
	...
	"aws_cloudwatch_log_anomaly_detector":                      ReplaceGroupWords("cloudwatchlogs", 2),
	...
	"aws_dx_macsec_key_association":                            ReplaceGroupWords("directconnect", 1),
	...
	"aws_ebs_snapshot_block_public_access":                     ReplaceGroupWords("ec2", 0),
	...
	"aws_ec2_client_vpn_authorization_rule":                    ReplaceGroupWords("vpnclient", 3),
	"aws_ec2_client_vpn_endpoint":                              ReplaceGroupWords("vpnclient", 3),
	"aws_ec2_client_vpn_network_association":                   ReplaceGroupWords("vpnclient", 3),
	"aws_ec2_client_vpn_route":                                 ReplaceGroupWords("vpnclient", 3),
	"aws_ec2_local_gateway_route_table_vpc_association":        ReplaceGroupWords("outposts", 3),
	"aws_ec2_local_gateway_route":                              ReplaceGroupWords("outposts", 3),
	"aws_egress_only_internet_gateway":                         ReplaceGroupWords("ec2", 0),
	"aws_eip_association":                                      ReplaceGroupWords("ec2", 0),
	"aws_eip_domain_name":                                      ReplaceGroupWords("ec2", 0),
	...
	"aws_verifiedaccess_endpoint":                              ReplaceGroupWords("verifiedaccess", 1),
	"aws_verifiedaccess_group":                                 ReplaceGroupWords("verifiedaccess", 1),
	"aws_verifiedaccess_instance_logging_configuration":        ReplaceGroupWords("verifiedaccess", 1),
	"aws_verifiedaccess_instance_trust_provider_attachment":    ReplaceGroupWords("verifiedaccess", 1),
	"aws_verifiedaccess_instance":                              ReplaceGroupWords("verifiedaccess", 1),
	"aws_verifiedaccess_trust_provider":                        ReplaceGroupWords("verifiedaccess", 1),
	"aws_volume_attachment":                                    ReplaceGroupWords("ec2", 0),
	"aws_vpc_block_public_access_exclusion":                    ReplaceGroupWords("ec2", 0),
	"aws_vpc_block_public_access_options":                      ReplaceGroupWords("ec2", 0),
	...
	"aws_vpc_endpoint_private_dns":                             ReplaceGroupWords("ec2", 0),
	...
	"aws_vpc_endpoint_service_private_dns_verification":        ReplaceGroupWords("ec2", 0),
	...
	"aws_vpc_security_group_vpc_association":                   ReplaceGroupWords("ec2", 0),
