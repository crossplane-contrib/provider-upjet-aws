...
pull-docs:
	@$(INFO) downloading terraform provider docs for $(TERRAFORM_PROVIDER_SOURCE) $(TERRAFORM_PROVIDER_VERSION)
	...
	@$(OK) downloading terraform provider docs for $(TERRAFORM_PROVIDER_SOURCE) $(TERRAFORM_PROVIDER_VERSION)
