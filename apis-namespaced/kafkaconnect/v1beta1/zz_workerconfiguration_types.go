...
type WorkerConfigurationSpec struct {
	...
	ForProvider     WorkerConfigurationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider WorkerConfigurationInitParameters `json:"initProvider,omitempty"`
}

// WorkerConfigurationStatus defines the observed state of WorkerConfiguration.
type WorkerConfigurationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        WorkerConfigurationObservation `json:"atProvider,omitempty"`
}
