...
// ConvertTo converts this MetricFilter to the hub type.
func (tr *MetricFilter) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the MetricFilter type.
func (tr *MetricFilter) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
