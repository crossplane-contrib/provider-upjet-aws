...
type ConditionInitParameters struct {
	...
	// Value for the key.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/organizations/v1beta1.Organization
...
type PermissionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/cloudwatchevents/v1beta1.Bus
