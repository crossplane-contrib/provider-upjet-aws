...
type TargetParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/events/v1beta1.Rule
	// +crossplane:generate:reference:extractor=github.com/upbound/upjet/pkg/resource.ExtractParamPath("name",false)
	// +kubebuilder:validation:Optional
	Rule *string `json:"rule,omitempty" tf:"rule,omitempty"`

	// Reference to a Rule in events to populate rule.
	// +kubebuilder:validation:Optional
	RuleRef *v1.Reference `json:"ruleRef,omitempty" tf:"-"`

	// Selector for a Rule in events to populate rule.
	// +kubebuilder:validation:Optional
