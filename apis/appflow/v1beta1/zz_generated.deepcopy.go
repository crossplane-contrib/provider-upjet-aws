...
func (in *RedshiftParameters) DeepCopyInto(out *RedshiftParameters) {
	*out = *in
	...
	if in.IntermediateBucketNameRef != nil {
		in, out := &in.IntermediateBucketNameRef, &out.IntermediateBucketNameRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.IntermediateBucketNameSelector != nil {
		in, out := &in.IntermediateBucketNameSelector, &out.IntermediateBucketNameSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Object != nil {
