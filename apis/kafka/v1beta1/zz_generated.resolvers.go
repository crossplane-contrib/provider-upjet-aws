...
func (mg *ScramSecretAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mrsp, err = r.ResolveMultiple(ctx, reference.MultiResolutionRequest{
		...
		Extract:       reference.ExternalName(),
		References:    mg.Spec.ForProvider.SecretArnListRefs,
		Selector:      mg.Spec.ForProvider.SecretArnListSelector,
		To: reference.To{
	...
	mg.Spec.ForProvider.SecretArnListRefs = mrsp.ResolvedReferences
