...
func (in *ClusterClientAuthenticationInitParameters) DeepCopyInto(out *ClusterClientAuthenticationInitParameters) {
	*out = *in
	if in.Sasl != nil {
		...
		*out = make([]ClusterSaslInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClusterClientAuthenticationObservation) DeepCopyInto(out *ClusterClientAuthenticationObservation) {
	*out = *in
	if in.Sasl != nil {
		in, out := &in.Sasl, &out.Sasl
		*out = make([]ClusterSaslObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ClusterClientAuthenticationParameters) DeepCopyInto(out *ClusterClientAuthenticationParameters) {
	*out = *in
	if in.Sasl != nil {
		in, out := &in.Sasl, &out.Sasl
		*out = make([]ClusterSaslParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSaslInitParameters) DeepCopyInto(out *ClusterSaslInitParameters) {
	*out = *in
	if in.IAM != nil {
		in, out := &in.IAM, &out.IAM
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSaslInitParameters.
func (in *ClusterSaslInitParameters) DeepCopy() *ClusterSaslInitParameters {
	if in == nil {
		return nil
	}
	out := new(ClusterSaslInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSaslObservation) DeepCopyInto(out *ClusterSaslObservation) {
	*out = *in
	if in.IAM != nil {
		in, out := &in.IAM, &out.IAM
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSaslObservation.
func (in *ClusterSaslObservation) DeepCopy() *ClusterSaslObservation {
	if in == nil {
		return nil
	}
	out := new(ClusterSaslObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterSaslParameters) DeepCopyInto(out *ClusterSaslParameters) {
	*out = *in
	if in.IAM != nil {
		in, out := &in.IAM, &out.IAM
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterSaslParameters.
func (in *ClusterSaslParameters) DeepCopy() *ClusterSaslParameters {
	if in == nil {
		return nil
	}
	out := new(ClusterSaslParameters)
	in.DeepCopyInto(out)
	return out
}
