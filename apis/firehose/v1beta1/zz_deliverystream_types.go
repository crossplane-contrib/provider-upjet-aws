...
type HTTPEndpointConfigurationParameters struct {
	...
	// The S3 Configuration. See s3_configuration for more details.
	// +kubebuilder:validation:Optional
	S3Configuration []HTTPEndpointConfigurationS3ConfigurationParameters `json:"s3Configuration,omitempty" tf:"s3_configuration,omitempty"`
...
type OpensearchConfigurationParameters struct {
	...
	// The S3 Configuration. See s3_configuration for more details.
	// +kubebuilder:validation:Optional
	S3Configuration []OpensearchConfigurationS3ConfigurationParameters `json:"s3Configuration,omitempty" tf:"s3_configuration,omitempty"`
...
type RedshiftConfigurationParameters struct {
	...
	// The S3 Configuration. See s3_configuration for more details.
	// +kubebuilder:validation:Optional
	S3Configuration []RedshiftConfigurationS3ConfigurationParameters `json:"s3Configuration,omitempty" tf:"s3_configuration,omitempty"`
...
type SplunkConfigurationParameters struct {
	...
	// The S3 Configuration. See s3_configuration for more details.
	// +kubebuilder:validation:Optional
	S3Configuration []SplunkConfigurationS3ConfigurationParameters `json:"s3Configuration,omitempty" tf:"s3_configuration,omitempty"`
}
