...
// ConvertTo converts this Insight to the hub type.
func (tr *Insight) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Insight type.
func (tr *Insight) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
