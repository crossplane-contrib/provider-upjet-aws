...
type AuthenticationConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/apprunner/v1beta1.Connection
...
type EgressConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/apprunner/v1beta1.VPCConnector
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractParamPath("arn",true)
...
type ServiceObservabilityConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/apprunner/v1beta1.ObservabilityConfiguration
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractParamPath("arn",true)
