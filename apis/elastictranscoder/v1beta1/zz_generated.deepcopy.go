...
func (in *PipelineParameters) DeepCopyInto(out *PipelineParameters) {
	*out = *in
	...
	if in.AwsKMSKeyArnRef != nil {
		in, out := &in.AwsKMSKeyArnRef, &out.AwsKMSKeyArnRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.AwsKMSKeyArnSelector != nil {
		in, out := &in.AwsKMSKeyArnSelector, &out.AwsKMSKeyArnSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.ContentConfig != nil {
