...
func (tr *Cluster) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"kerberos_attributes[*].ad_domain_join_password": "kerberosAttributes[*].adDomainJoinPasswordSecretRef", "kerberos_attributes[*].cross_realm_trust_principal_password": "kerberosAttributes[*].crossRealmTrustPrincipalPasswordSecretRef", "kerberos_attributes[*].kdc_admin_password": "kerberosAttributes[*].kdcAdminPasswordSecretRef"}
}
