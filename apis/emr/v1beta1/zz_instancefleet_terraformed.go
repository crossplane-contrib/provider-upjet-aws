...
func (tr *InstanceFleet) GetObservation() (map[string]any, error) {
...
func (tr *InstanceFleet) SetObservation(obs map[string]any) error {
...
func (tr *InstanceFleet) GetParameters() (map[string]any, error) {
...
func (tr *InstanceFleet) SetParameters(params map[string]any) error {
...
// GetInitParameters of this InstanceFleet
func (tr *InstanceFleet) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this InstanceFleet
func (tr *InstanceFleet) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
