...
type ConnectAttachmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/networkmanager/v1beta1.CoreNetwork
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/networkmanager/v1beta1.VPCAttachment
