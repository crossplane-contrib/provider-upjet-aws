...
func (tr *Connection) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"athena_properties": "athenaPropertiesSecretRef", "authentication_configuration[*].basic_authentication_credentials[*].password": "authenticationConfiguration.basicAuthenticationCredentials.passwordSecretRef", "authentication_configuration[*].custom_authentication_credentials": "authenticationConfiguration.customAuthenticationCredentialsSecretRef", "authentication_configuration[*].oauth2_properties[*].authorization_code_properties[*].authorization_code": "authenticationConfiguration.oauth2Properties.authorizationCodeProperties.authorizationCodeSecretRef", "authentication_configuration[*].oauth2_properties[*].oauth2_credentials[*].access_token": "authenticationConfiguration.oauth2Properties.oauth2Credentials.accessTokenSecretRef", "authentication_configuration[*].oauth2_properties[*].oauth2_credentials[*].jwt_token": "authenticationConfiguration.oauth2Properties.oauth2Credentials.jwtTokenSecretRef", "authentication_configuration[*].oauth2_properties[*].oauth2_credentials[*].refresh_token": "authenticationConfiguration.oauth2Properties.oauth2Credentials.refreshTokenSecretRef", "authentication_configuration[*].oauth2_properties[*].oauth2_credentials[*].user_managed_client_application_client_secret": "authenticationConfiguration.oauth2Properties.oauth2Credentials.userManagedClientApplicationClientSecretSecretRef", "authentication_configuration[*].oauth2_properties[*].token_url_parameters_map": "authenticationConfiguration.oauth2Properties.tokenUrlParametersMapSecretRef", "connection_properties": "connectionPropertiesSecretRef"}
}
