...
type FieldsInitParameters struct {
	...
	// The transformation function applied to the source field to create the partition. Common values: identity, bucket, truncate, year, month, day, hour.
...
type IcebergTableInputInitParameters struct {
	...
	Schema []IcebergSchemaInitParameters `json:"schema,omitempty" tf:"schema,omitempty"`
...
type IcebergTableInputObservation struct {
	...
	// The schema definition that specifies the structure, field types, and metadata for the Iceberg table. See schema below.
	Schema []IcebergSchemaObservation `json:"schema,omitempty" tf:"schema,omitempty"`
...
type IcebergTableInputParameters struct {
	...
	// The schema definition that specifies the structure, field types, and metadata for the Iceberg table. See schema below.
	// +kubebuilder:validation:Optional
	Schema []IcebergSchemaParameters `json:"schema" tf:"schema,omitempty"`
...
type RepresentationsInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/glue/v1beta1.Connection
	...
	// +kubebuilder:validation:Optional
	ValidationConnectionRef *v1.Reference `json:"validationConnectionRef,omitempty" tf:"-"`

	// Selector for a Connection in glue to populate validationConnection.
	// +kubebuilder:validation:Optional
	ValidationConnectionSelector *v1.Selector `json:"validationConnectionSelector,omitempty" tf:"-"`
...
type IcebergSchemaInitParameters struct {
	...
	// The root type of the schema structure. Valid value: struct.
	Type *string `json:"type,omitempty" tf:"type,omitempty"`
}

type IcebergSchemaObservation struct {
...
type IcebergSchemaParameters struct {
