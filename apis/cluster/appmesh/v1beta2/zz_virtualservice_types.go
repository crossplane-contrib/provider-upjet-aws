...
type ProviderVirtualNodeInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/appmesh/v1beta2.VirtualNode
	...
	// +kubebuilder:validation:Optional
	VirtualNodeNameRef *v2.Reference `json:"virtualNodeNameRef,omitempty" tf:"-"`

	// Selector for a VirtualNode in appmesh to populate virtualNodeName.
	// +kubebuilder:validation:Optional
	VirtualNodeNameSelector *v2.Selector `json:"virtualNodeNameSelector,omitempty" tf:"-"`
}
...
type ProviderVirtualRouterInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/appmesh/v1beta2.VirtualRouter
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("name",false)
