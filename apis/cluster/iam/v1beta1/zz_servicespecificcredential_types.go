...
type ServiceSpecificCredentialInitParameters struct {
	...
	CredentialAgeDays *float64 `json:"credentialAgeDays,omitempty" tf:"credential_age_days,omitempty"`
...
type ServiceSpecificCredentialObservation struct {
	...
	ServiceCredentialAlias *string `json:"serviceCredentialAlias,omitempty" tf:"service_credential_alias,omitempty"`
