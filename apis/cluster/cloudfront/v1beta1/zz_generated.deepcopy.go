...
func (in *CustomOriginConfigInitParameters) DeepCopyInto(out *CustomOriginConfigInitParameters) {
	*out = *in
	...
	if in.OriginMtlsConfig != nil {
		...
		*out = make([]OriginMtlsConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CustomOriginConfigObservation) DeepCopyInto(out *CustomOriginConfigObservation) {
	*out = *in
	...
	if in.OriginMtlsConfig != nil {
		in, out := &in.OriginMtlsConfig, &out.OriginMtlsConfig
		*out = make([]OriginMtlsConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CustomOriginConfigParameters) DeepCopyInto(out *CustomOriginConfigParameters) {
	*out = *in
	...
	if in.OriginMtlsConfig != nil {
		in, out := &in.OriginMtlsConfig, &out.OriginMtlsConfig
		*out = make([]OriginMtlsConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DistributionInitParameters) DeepCopyInto(out *DistributionInitParameters) {
	*out = *in
	...
	if in.CacheTagConfig != nil {
		...
		*out = make([]CacheTagConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DistributionObservation) DeepCopyInto(out *DistributionObservation) {
	*out = *in
	...
	if in.CacheTagConfig != nil {
		in, out := &in.CacheTagConfig, &out.CacheTagConfig
		*out = make([]CacheTagConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DistributionParameters) DeepCopyInto(out *DistributionParameters) {
	*out = *in
	...
	if in.CacheTagConfig != nil {
		in, out := &in.CacheTagConfig, &out.CacheTagConfig
		*out = make([]CacheTagConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FunctionInitParameters) DeepCopyInto(out *FunctionInitParameters) {
	*out = *in
	...
	if in.KeyValueStoreAssociationsRefs != nil {
		in, out := &in.KeyValueStoreAssociationsRefs, &out.KeyValueStoreAssociationsRefs
		*out = make([]v2.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.KeyValueStoreAssociationsSelector != nil {
		in, out := &in.KeyValueStoreAssociationsSelector, &out.KeyValueStoreAssociationsSelector
		*out = new(v2.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Publish != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KeyValueStoreInitParameters) DeepCopyInto(out *KeyValueStoreInitParameters) {
	*out = *in
	if in.Comment != nil {
		in, out := &in.Comment, &out.Comment
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KeyValueStoreInitParameters.
func (in *KeyValueStoreInitParameters) DeepCopy() *KeyValueStoreInitParameters {
	if in == nil {
		return nil
	}
	out := new(KeyValueStoreInitParameters)
	in.DeepCopyInto(out)
	return out
}
