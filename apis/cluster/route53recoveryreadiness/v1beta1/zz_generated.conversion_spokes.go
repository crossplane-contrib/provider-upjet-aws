...
// ConvertTo converts this ResourceSet to the hub type.
func (tr *ResourceSet) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ResourceSet type.
func (tr *ResourceSet) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
