...
func (tr *RepositoryPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
	...
	if err != nil {
		return nil, errors.Wrapf(err, "cannot get parameters for RepositoryPolicy %q", tr.GetNamespace()+"/"+tr.GetName())
	}
	...
	if err != nil {
		return nil, errors.Wrapf(err, "cannot get init parameters for RepositoryPolicy %q", tr.GetNamespace()+"/"+tr.GetName())
	}
	...
	if err != nil {
		return nil, errors.Wrapf(err, "cannot merge spec.initProvider and spec.forProvider parameters for RepositoryPolicy %q", tr.GetNamespace()+"/"+tr.GetName())
	}
