...
type NotebookInstanceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/sagemaker/v1beta2.CodeRepository
	...
	// +kubebuilder:validation:Optional
	DefaultCodeRepositoryRef *v2.Reference `json:"defaultCodeRepositoryRef,omitempty" tf:"-"`

	// Selector for a CodeRepository in sagemaker to populate defaultCodeRepository.
	// +kubebuilder:validation:Optional
	DefaultCodeRepositorySelector *v2.Selector `json:"defaultCodeRepositorySelector,omitempty" tf:"-"`
