...
type DestinationTableConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/glue/v1beta1.CatalogDatabase
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/glue/v1beta1.CatalogTable
...
type ElasticsearchConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/elasticsearch/v1beta1.Domain
...
type OpensearchConfigurationInitParameters struct {
	...
	// The ARN of the Amazon ES domain.  The pattern needs to be arn:.*.  Conflicts with cluster_endpoint.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/opensearch/v1beta1.Domain
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("arn",true)
	DomainArn *string `json:"domainArn,omitempty" tf:"domain_arn,omitempty"`
...
type OpensearchserverlessConfigurationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/opensearchserverless/v1beta1.Collection
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("collection_endpoint",true)
	...
	// +kubebuilder:validation:Optional
	CollectionEndpointRef *v2.Reference `json:"collectionEndpointRef,omitempty" tf:"-"`

	// Selector for a Collection in opensearchserverless to populate collectionEndpoint.
	// +kubebuilder:validation:Optional
	CollectionEndpointSelector *v2.Selector `json:"collectionEndpointSelector,omitempty" tf:"-"`
...
type SnowflakeConfigurationInitParameters struct {
	...
	KeyPassphraseSecretRef *v2.SecretKeySelector `json:"keyPassphraseSecretRef,omitempty" tf:"-"`
