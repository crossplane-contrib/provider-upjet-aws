...
type AmazonMskClusterInitParameters struct {
	...
	MskClusterArnRef *v2.Reference `json:"mskClusterArnRef,omitempty" tf:"-"`
...
type ReplicationInfoListInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceKafkaClusterArnRef *v2.Reference `json:"sourceKafkaClusterArnRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	TargetKafkaClusterArnRef *v2.Reference `json:"targetKafkaClusterArnRef,omitempty" tf:"-"`
...
type ReplicatorInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ServiceExecutionRoleArnRef *v2.Reference `json:"serviceExecutionRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate serviceExecutionRoleArn.
	// +kubebuilder:validation:Optional
	ServiceExecutionRoleArnSelector *v2.Selector `json:"serviceExecutionRoleArnSelector,omitempty" tf:"-"`
...
type VPCConfigInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SecurityGroupsIdsRefs []v2.Reference `json:"securityGroupsIdsRefs,omitempty" tf:"-"`

	// Selector for a list of SecurityGroup in ec2 to populate securityGroupsIds.
	// +kubebuilder:validation:Optional
	SecurityGroupsIdsSelector *v2.Selector `json:"securityGroupsIdsSelector,omitempty" tf:"-"`
