...
type ClusterObservation struct {
	...
	BootstrapBrokersIPv6 *string `json:"bootstrapBrokersIpv6,omitempty" tf:"bootstrap_brokers_ipv6,omitempty"`
	...
	BootstrapBrokersSaslIAMIPv6 *string `json:"bootstrapBrokersSaslIamIpv6,omitempty" tf:"bootstrap_brokers_sasl_iam_ipv6,omitempty"`
	...
	BootstrapBrokersSaslScramIPv6 *string `json:"bootstrapBrokersSaslScramIpv6,omitempty" tf:"bootstrap_brokers_sasl_scram_ipv6,omitempty"`
	...
	BootstrapBrokersTLSIPv6 *string `json:"bootstrapBrokersTlsIpv6,omitempty" tf:"bootstrap_brokers_tls_ipv6,omitempty"`
...
type ConfigurationInfoInitParameters struct {
	...
	// ARN of the MSK Configuration to use in the cluster.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/kafka/v1beta1.Configuration
...
type EncryptionInfoInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	EncryptionAtRestKMSKeyArnRef *v2.Reference `json:"encryptionAtRestKmsKeyArnRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate encryptionAtRestKmsKeyArn.
	// +kubebuilder:validation:Optional
	EncryptionAtRestKMSKeyArnSelector *v2.Selector `json:"encryptionAtRestKmsKeyArnSelector,omitempty" tf:"-"`
