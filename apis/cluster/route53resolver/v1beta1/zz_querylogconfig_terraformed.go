...
// GetInitParameters of this QueryLogConfig
func (tr *QueryLogConfig) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this QueryLogConfig
func (tr *QueryLogConfig) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
