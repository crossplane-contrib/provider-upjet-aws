...
// GetInitParameters of this DNSSECConfig
func (tr *DNSSECConfig) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this DNSSECConfig
func (tr *DNSSECConfig) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
