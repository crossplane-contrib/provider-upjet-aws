...
type VPCAttachmentInitParameters struct {
	...
	CoreNetworkIDRef *v2.Reference `json:"coreNetworkIdRef,omitempty" tf:"-"`

	// Selector for a CoreNetwork in networkmanager to populate coreNetworkId.
	// +kubebuilder:validation:Optional
	CoreNetworkIDSelector *v2.Selector `json:"coreNetworkIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SubnetArnsRefs []v2.Reference `json:"subnetArnsRefs,omitempty" tf:"-"`

	// Selector for a list of Subnet in ec2 to populate subnetArns.
	// +kubebuilder:validation:Optional
	SubnetArnsSelector *v2.Selector `json:"subnetArnsSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	VPCArnRef *v2.Reference `json:"vpcArnRef,omitempty" tf:"-"`

	// Selector for a VPC in ec2 to populate vpcArn.
	// +kubebuilder:validation:Optional
	VPCArnSelector *v2.Selector `json:"vpcArnSelector,omitempty" tf:"-"`
}
