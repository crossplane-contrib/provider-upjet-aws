...
// ConvertTo converts this TestGridProject to the hub type.
func (tr *TestGridProject) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the TestGridProject type.
func (tr *TestGridProject) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
