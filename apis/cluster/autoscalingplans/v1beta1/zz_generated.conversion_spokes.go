...
// ConvertTo converts this ScalingPlan to the hub type.
func (tr *ScalingPlan) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ScalingPlan type.
func (tr *ScalingPlan) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
