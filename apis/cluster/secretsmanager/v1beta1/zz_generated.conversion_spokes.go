...
// ConvertTo converts this SecretRotation to the hub type.
func (tr *SecretRotation) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the SecretRotation type.
func (tr *SecretRotation) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
