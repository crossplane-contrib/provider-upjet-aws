...
func (in *ExternalSecretRotationMetadataInitParameters) DeepCopyInto(out *ExternalSecretRotationMetadataInitParameters) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalSecretRotationMetadataInitParameters.
func (in *ExternalSecretRotationMetadataInitParameters) DeepCopy() *ExternalSecretRotationMetadataInitParameters {
	if in == nil {
		return nil
	}
	out := new(ExternalSecretRotationMetadataInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalSecretRotationMetadataObservation) DeepCopyInto(out *ExternalSecretRotationMetadataObservation) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalSecretRotationMetadataObservation.
func (in *ExternalSecretRotationMetadataObservation) DeepCopy() *ExternalSecretRotationMetadataObservation {
	if in == nil {
		return nil
	}
	out := new(ExternalSecretRotationMetadataObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalSecretRotationMetadataParameters) DeepCopyInto(out *ExternalSecretRotationMetadataParameters) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalSecretRotationMetadataParameters.
func (in *ExternalSecretRotationMetadataParameters) DeepCopy() *ExternalSecretRotationMetadataParameters {
	if in == nil {
		return nil
	}
	out := new(ExternalSecretRotationMetadataParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretRotationInitParameters) DeepCopyInto(out *SecretRotationInitParameters) {
	*out = *in
	if in.ExternalSecretRotationMetadata != nil {
		in, out := &in.ExternalSecretRotationMetadata, &out.ExternalSecretRotationMetadata
		*out = make([]ExternalSecretRotationMetadataInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ExternalSecretRotationRoleArn != nil {
		in, out := &in.ExternalSecretRotationRoleArn, &out.ExternalSecretRotationRoleArn
		*out = new(string)
		**out = **in
	}
	if in.ExternalSecretRotationRoleArnRef != nil {
		in, out := &in.ExternalSecretRotationRoleArnRef, &out.ExternalSecretRotationRoleArnRef
		*out = new(v2.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.ExternalSecretRotationRoleArnSelector != nil {
		in, out := &in.ExternalSecretRotationRoleArnSelector, &out.ExternalSecretRotationRoleArnSelector
		*out = new(v2.Selector)
		(*in).DeepCopyInto(*out)
	}
...
func (in *SecretRotationObservation) DeepCopyInto(out *SecretRotationObservation) {
	*out = *in
	if in.ExternalSecretRotationMetadata != nil {
		in, out := &in.ExternalSecretRotationMetadata, &out.ExternalSecretRotationMetadata
		*out = make([]ExternalSecretRotationMetadataObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SecretRotationParameters) DeepCopyInto(out *SecretRotationParameters) {
	*out = *in
	if in.ExternalSecretRotationMetadata != nil {
		in, out := &in.ExternalSecretRotationMetadata, &out.ExternalSecretRotationMetadata
		*out = make([]ExternalSecretRotationMetadataParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
