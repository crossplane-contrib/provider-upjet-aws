...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentStrategyOptionsInitParameters) DeepCopyInto(out *DeploymentStrategyOptionsInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentStrategyOptionsInitParameters.
func (in *DeploymentStrategyOptionsInitParameters) DeepCopy() *DeploymentStrategyOptionsInitParameters {
	if in == nil {
		return nil
	}
	out := new(DeploymentStrategyOptionsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentStrategyOptionsObservation) DeepCopyInto(out *DeploymentStrategyOptionsObservation) {
	*out = *in
	if in.DeploymentStrategy != nil {
		in, out := &in.DeploymentStrategy, &out.DeploymentStrategy
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentStrategyOptionsObservation.
func (in *DeploymentStrategyOptionsObservation) DeepCopy() *DeploymentStrategyOptionsObservation {
	if in == nil {
		return nil
	}
	out := new(DeploymentStrategyOptionsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeploymentStrategyOptionsParameters) DeepCopyInto(out *DeploymentStrategyOptionsParameters) {
	*out = *in
	if in.DeploymentStrategy != nil {
		in, out := &in.DeploymentStrategy, &out.DeploymentStrategy
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentStrategyOptionsParameters.
func (in *DeploymentStrategyOptionsParameters) DeepCopy() *DeploymentStrategyOptionsParameters {
	if in == nil {
		return nil
	}
	out := new(DeploymentStrategyOptionsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DomainInitParameters) DeepCopyInto(out *DomainInitParameters) {
	*out = *in
	...
	if in.DeploymentStrategyOptions != nil {
		in, out := &in.DeploymentStrategyOptions, &out.DeploymentStrategyOptions
		*out = make([]DeploymentStrategyOptionsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DomainObservation) DeepCopyInto(out *DomainObservation) {
	*out = *in
	...
	if in.DeploymentStrategyOptions != nil {
		in, out := &in.DeploymentStrategyOptions, &out.DeploymentStrategyOptions
		*out = make([]DeploymentStrategyOptionsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *DomainParameters) DeepCopyInto(out *DomainParameters) {
	*out = *in
	...
	if in.DeploymentStrategyOptions != nil {
		in, out := &in.DeploymentStrategyOptions, &out.DeploymentStrategyOptions
		*out = make([]DeploymentStrategyOptionsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
