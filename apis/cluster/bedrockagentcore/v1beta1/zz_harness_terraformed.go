...
// GetTerraformResourceType returns Terraform resource type for this Harness
func (mg *Harness) GetTerraformResourceType() string {
	return "aws_bedrockagentcore_harness"
}
...
func (tr *Harness) GetObservation() (map[string]any, error) {
...
// SetObservation for this Harness
func (tr *Harness) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this Harness
func (tr *Harness) GetID() string {
...
// GetParameters of this Harness
func (tr *Harness) GetParameters() (map[string]any, error) {
...
// SetParameters for this Harness
func (tr *Harness) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Harness
func (tr *Harness) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Harness
func (tr *Harness) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this Harness using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *Harness) LateInitialize(attrs []byte) (bool, error) {
...
func (tr *Harness) GetTerraformSchemaVersion() int {
	return 0
}
