...
// ConvertTo converts this ObservabilityConfiguration to the hub type.
func (tr *ObservabilityConfiguration) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ObservabilityConfiguration type.
func (tr *ObservabilityConfiguration) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
