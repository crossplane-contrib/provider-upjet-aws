...
func (tr *ReportGroup) GetObservation() (map[string]any, error) {
...
func (tr *ReportGroup) GetParameters() (map[string]any, error) {
...
func (tr *ReportGroup) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ReportGroup
func (tr *ReportGroup) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ReportGroup
func (tr *ReportGroup) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
