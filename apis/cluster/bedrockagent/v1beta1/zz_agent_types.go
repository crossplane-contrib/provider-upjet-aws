...
type AgentInitParameters struct {
	...
	AgentResourceRoleArnRef *v2.Reference `json:"agentResourceRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate agentResourceRoleArn.
	// +kubebuilder:validation:Optional
	AgentResourceRoleArnSelector *v2.Selector `json:"agentResourceRoleArnSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	CustomerEncryptionKeyArnRef *v2.Reference `json:"customerEncryptionKeyArnRef,omitempty" tf:"-"`

	// Selector for a Key in kms to populate customerEncryptionKeyArn.
	// +kubebuilder:validation:Optional
	CustomerEncryptionKeyArnSelector *v2.Selector `json:"customerEncryptionKeyArnSelector,omitempty" tf:"-"`
