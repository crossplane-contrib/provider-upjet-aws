...
// ConvertTo converts this MultiRegionCluster to the hub type.
func (tr *MultiRegionCluster) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the MultiRegionCluster type.
func (tr *MultiRegionCluster) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
