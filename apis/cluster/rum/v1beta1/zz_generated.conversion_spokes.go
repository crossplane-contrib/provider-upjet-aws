...
// ConvertTo converts this AppMonitor to the hub type.
func (tr *AppMonitor) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the AppMonitor type.
func (tr *AppMonitor) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
