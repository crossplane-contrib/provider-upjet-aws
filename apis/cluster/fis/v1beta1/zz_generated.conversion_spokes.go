...
// ConvertTo converts this ExperimentTemplate to the hub type.
func (tr *ExperimentTemplate) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ExperimentTemplate type.
func (tr *ExperimentTemplate) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
