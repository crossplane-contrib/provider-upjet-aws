...
func (in *AccessEndpointConfigInitParameters) DeepCopyInto(out *AccessEndpointConfigInitParameters) {
	*out = *in
	...
	if in.InternetFallbackProtocols != nil {
		in, out := &in.InternetFallbackProtocols, &out.InternetFallbackProtocols
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessEndpointConfigInitParameters.
func (in *AccessEndpointConfigInitParameters) DeepCopy() *AccessEndpointConfigInitParameters {
	if in == nil {
		return nil
	}
	out := new(AccessEndpointConfigInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessEndpointConfigObservation) DeepCopyInto(out *AccessEndpointConfigObservation) {
	*out = *in
	if in.AccessEndpoints != nil {
		in, out := &in.AccessEndpoints, &out.AccessEndpoints
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessEndpointConfigObservation.
func (in *AccessEndpointConfigObservation) DeepCopy() *AccessEndpointConfigObservation {
	if in == nil {
		return nil
	}
	out := new(AccessEndpointConfigObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AccessEndpointConfigParameters) DeepCopyInto(out *AccessEndpointConfigParameters) {
	*out = *in
	if in.AccessEndpoints != nil {
		in, out := &in.AccessEndpoints, &out.AccessEndpoints
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AccessEndpointConfigParameters.
func (in *AccessEndpointConfigParameters) DeepCopy() *AccessEndpointConfigParameters {
	if in == nil {
		return nil
	}
	out := new(AccessEndpointConfigParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkspaceAccessPropertiesInitParameters) DeepCopyInto(out *WorkspaceAccessPropertiesInitParameters) {
	*out = *in
	if in.AccessEndpointConfig != nil {
		in, out := &in.AccessEndpointConfig, &out.AccessEndpointConfig
		*out = make([]AccessEndpointConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceAccessPropertiesObservation) DeepCopyInto(out *WorkspaceAccessPropertiesObservation) {
	*out = *in
	if in.AccessEndpointConfig != nil {
		in, out := &in.AccessEndpointConfig, &out.AccessEndpointConfig
		*out = make([]AccessEndpointConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WorkspaceAccessPropertiesParameters) DeepCopyInto(out *WorkspaceAccessPropertiesParameters) {
	*out = *in
	if in.AccessEndpointConfig != nil {
		in, out := &in.AccessEndpointConfig, &out.AccessEndpointConfig
		*out = make([]AccessEndpointConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
