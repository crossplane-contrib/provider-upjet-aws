...
type ImageInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/imagebuilder/v1beta1.DistributionConfiguration
	...
	// +kubebuilder:validation:Optional
	DistributionConfigurationArnRef *v2.Reference `json:"distributionConfigurationArnRef,omitempty" tf:"-"`

	// Selector for a DistributionConfiguration in imagebuilder to populate distributionConfigurationArn.
	// +kubebuilder:validation:Optional
	DistributionConfigurationArnSelector *v2.Selector `json:"distributionConfigurationArnSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/imagebuilder/v1beta1.ImageRecipe
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("arn",true)
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/imagebuilder/v1beta1.InfrastructureConfiguration
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractParamPath("arn",true)
