...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EvaluationCriteriaInitParameters) DeepCopyInto(out *EvaluationCriteriaInitParameters) {
	*out = *in
	if in.PromqlCriteria != nil {
		in, out := &in.PromqlCriteria, &out.PromqlCriteria
		*out = make([]PromqlCriteriaInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvaluationCriteriaInitParameters.
func (in *EvaluationCriteriaInitParameters) DeepCopy() *EvaluationCriteriaInitParameters {
	if in == nil {
		return nil
	}
	out := new(EvaluationCriteriaInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EvaluationCriteriaObservation) DeepCopyInto(out *EvaluationCriteriaObservation) {
	*out = *in
	if in.PromqlCriteria != nil {
		in, out := &in.PromqlCriteria, &out.PromqlCriteria
		*out = make([]PromqlCriteriaObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvaluationCriteriaObservation.
func (in *EvaluationCriteriaObservation) DeepCopy() *EvaluationCriteriaObservation {
	if in == nil {
		return nil
	}
	out := new(EvaluationCriteriaObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EvaluationCriteriaParameters) DeepCopyInto(out *EvaluationCriteriaParameters) {
	*out = *in
	if in.PromqlCriteria != nil {
		in, out := &in.PromqlCriteria, &out.PromqlCriteria
		*out = make([]PromqlCriteriaParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EvaluationCriteriaParameters.
func (in *EvaluationCriteriaParameters) DeepCopy() *EvaluationCriteriaParameters {
	if in == nil {
		return nil
	}
	out := new(EvaluationCriteriaParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetricAlarmInitParameters) DeepCopyInto(out *MetricAlarmInitParameters) {
	*out = *in
	...
	if in.EvaluationCriteria != nil {
		...
		*out = make([]EvaluationCriteriaInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WarmUpConfiguration != nil {
		in, out := &in.WarmUpConfiguration, &out.WarmUpConfiguration
		*out = make([]WarmUpConfigurationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MetricAlarmObservation) DeepCopyInto(out *MetricAlarmObservation) {
	*out = *in
	...
	if in.EvaluationCriteria != nil {
		in, out := &in.EvaluationCriteria, &out.EvaluationCriteria
		*out = make([]EvaluationCriteriaObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WarmUpConfiguration != nil {
		in, out := &in.WarmUpConfiguration, &out.WarmUpConfiguration
		*out = make([]WarmUpConfigurationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MetricAlarmParameters) DeepCopyInto(out *MetricAlarmParameters) {
	*out = *in
	...
	if in.EvaluationCriteria != nil {
		in, out := &in.EvaluationCriteria, &out.EvaluationCriteria
		*out = make([]EvaluationCriteriaParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WarmUpConfiguration != nil {
		in, out := &in.WarmUpConfiguration, &out.WarmUpConfiguration
		*out = make([]WarmUpConfigurationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromqlCriteriaInitParameters) DeepCopyInto(out *PromqlCriteriaInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromqlCriteriaInitParameters.
func (in *PromqlCriteriaInitParameters) DeepCopy() *PromqlCriteriaInitParameters {
	if in == nil {
		return nil
	}
	out := new(PromqlCriteriaInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromqlCriteriaObservation) DeepCopyInto(out *PromqlCriteriaObservation) {
	*out = *in
	if in.PendingPeriod != nil {
		in, out := &in.PendingPeriod, &out.PendingPeriod
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromqlCriteriaObservation.
func (in *PromqlCriteriaObservation) DeepCopy() *PromqlCriteriaObservation {
	if in == nil {
		return nil
	}
	out := new(PromqlCriteriaObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PromqlCriteriaParameters) DeepCopyInto(out *PromqlCriteriaParameters) {
	*out = *in
	if in.PendingPeriod != nil {
		in, out := &in.PendingPeriod, &out.PendingPeriod
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PromqlCriteriaParameters.
func (in *PromqlCriteriaParameters) DeepCopy() *PromqlCriteriaParameters {
	if in == nil {
		return nil
	}
	out := new(PromqlCriteriaParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WarmUpConfigurationInitParameters) DeepCopyInto(out *WarmUpConfigurationInitParameters) {
	*out = *in
	if in.OnlyStartEvaluatingAfterWarmUpPeriodEnds != nil {
		in, out := &in.OnlyStartEvaluatingAfterWarmUpPeriodEnds, &out.OnlyStartEvaluatingAfterWarmUpPeriodEnds
		*out = new(bool)
		**out = **in
	}
	if in.WarmUpPeriodDurationInMinutes != nil {
		in, out := &in.WarmUpPeriodDurationInMinutes, &out.WarmUpPeriodDurationInMinutes
		*out = new(float64)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WarmUpConfigurationInitParameters.
func (in *WarmUpConfigurationInitParameters) DeepCopy() *WarmUpConfigurationInitParameters {
	if in == nil {
		return nil
	}
	out := new(WarmUpConfigurationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WarmUpConfigurationObservation) DeepCopyInto(out *WarmUpConfigurationObservation) {
	*out = *in
	if in.OnlyStartEvaluatingAfterWarmUpPeriodEnds != nil {
		in, out := &in.OnlyStartEvaluatingAfterWarmUpPeriodEnds, &out.OnlyStartEvaluatingAfterWarmUpPeriodEnds
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WarmUpConfigurationObservation.
func (in *WarmUpConfigurationObservation) DeepCopy() *WarmUpConfigurationObservation {
	if in == nil {
		return nil
	}
	out := new(WarmUpConfigurationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WarmUpConfigurationParameters) DeepCopyInto(out *WarmUpConfigurationParameters) {
	*out = *in
	if in.OnlyStartEvaluatingAfterWarmUpPeriodEnds != nil {
		in, out := &in.OnlyStartEvaluatingAfterWarmUpPeriodEnds, &out.OnlyStartEvaluatingAfterWarmUpPeriodEnds
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WarmUpConfigurationParameters.
func (in *WarmUpConfigurationParameters) DeepCopy() *WarmUpConfigurationParameters {
	if in == nil {
		return nil
	}
	out := new(WarmUpConfigurationParameters)
	in.DeepCopyInto(out)
	return out
}
