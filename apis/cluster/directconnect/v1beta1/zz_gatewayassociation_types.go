...
type GatewayAssociationInitParameters struct {
	...
	// Used for cross-account Direct Connect gateway associations.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/directconnect/v1beta1.GatewayAssociationProposal
	...
	// +kubebuilder:validation:Optional
	ProposalIDRef *v2.Reference `json:"proposalIdRef,omitempty" tf:"-"`

	// Selector for a GatewayAssociationProposal in directconnect to populate proposalId.
	// +kubebuilder:validation:Optional
	ProposalIDSelector *v2.Selector `json:"proposalIdSelector,omitempty" tf:"-"`
}
