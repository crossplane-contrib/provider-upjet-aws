...
// ConvertTo converts this Record to the hub type.
func (tr *Record) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Record type.
func (tr *Record) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
