...
func (in *FlowLogInitParameters) DeepCopyInto(out *FlowLogInitParameters) {
	*out = *in
	...
	if in.TagFieldSpecification != nil {
		in, out := &in.TagFieldSpecification, &out.TagFieldSpecification
		*out = make([]TagFieldSpecificationInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FlowLogObservation) DeepCopyInto(out *FlowLogObservation) {
	*out = *in
	...
	if in.TagFieldSpecification != nil {
		in, out := &in.TagFieldSpecification, &out.TagFieldSpecification
		*out = make([]TagFieldSpecificationObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *FlowLogParameters) DeepCopyInto(out *FlowLogParameters) {
	*out = *in
	...
	if in.TagFieldSpecification != nil {
		in, out := &in.TagFieldSpecification, &out.TagFieldSpecification
		*out = make([]TagFieldSpecificationParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TagFieldSpecificationInitParameters) DeepCopyInto(out *TagFieldSpecificationInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TagFieldSpecificationInitParameters.
func (in *TagFieldSpecificationInitParameters) DeepCopy() *TagFieldSpecificationInitParameters {
	if in == nil {
		return nil
	}
	out := new(TagFieldSpecificationInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TagFieldSpecificationObservation) DeepCopyInto(out *TagFieldSpecificationObservation) {
	*out = *in
	if in.ResourceType != nil {
		in, out := &in.ResourceType, &out.ResourceType
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TagFieldSpecificationObservation.
func (in *TagFieldSpecificationObservation) DeepCopy() *TagFieldSpecificationObservation {
	if in == nil {
		return nil
	}
	out := new(TagFieldSpecificationObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TagFieldSpecificationParameters) DeepCopyInto(out *TagFieldSpecificationParameters) {
	*out = *in
	if in.ResourceType != nil {
		in, out := &in.ResourceType, &out.ResourceType
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TagFieldSpecificationParameters.
func (in *TagFieldSpecificationParameters) DeepCopy() *TagFieldSpecificationParameters {
	if in == nil {
		return nil
	}
	out := new(TagFieldSpecificationParameters)
	in.DeepCopyInto(out)
	return out
}
