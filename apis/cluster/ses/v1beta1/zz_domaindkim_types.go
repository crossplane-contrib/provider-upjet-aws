...
type DomainDKIMObservation struct {
	...
	// DKIM tokens generated by SES. These tokens should be used to create CNAME records used to verify SES Easy DKIM. Find out more about verifying domains in Amazon SES in the AWS SES docs.
