...
// ConvertTo converts this LanguageModel to the hub type.
func (tr *LanguageModel) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the LanguageModel type.
func (tr *LanguageModel) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
