...
func (mg *LanguageModel) GetDeletionPolicy() xpv2.DeletionPolicy {
...
func (mg *LanguageModel) GetProviderConfigReference() *xpv2.Reference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this LanguageModel.
func (mg *LanguageModel) GetWriteConnectionSecretToReference() *xpv2.SecretReference {
...
func (mg *LanguageModel) SetDeletionPolicy(r xpv2.DeletionPolicy) {
...
func (mg *LanguageModel) SetProviderConfigReference(r *xpv2.Reference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this LanguageModel.
func (mg *LanguageModel) SetWriteConnectionSecretToReference(r *xpv2.SecretReference) {
...
func (mg *VocabularyFilter) GetDeletionPolicy() xpv2.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}
...
func (mg *VocabularyFilter) GetProviderConfigReference() *xpv2.Reference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this VocabularyFilter.
func (mg *VocabularyFilter) GetWriteConnectionSecretToReference() *xpv2.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}
...
func (mg *VocabularyFilter) SetDeletionPolicy(r xpv2.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}
...
func (mg *VocabularyFilter) SetProviderConfigReference(r *xpv2.Reference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this VocabularyFilter.
func (mg *VocabularyFilter) SetWriteConnectionSecretToReference(r *xpv2.SecretReference) {
	mg.Spec.WriteConnectionSecretToReference = r
}
