...
type InputInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	InputSecurityGroupsRefs []v2.Reference `json:"inputSecurityGroupsRefs,omitempty" tf:"-"`

	// Selector for a list of InputSecurityGroup in medialive to populate inputSecurityGroups.
	// +kubebuilder:validation:Optional
	InputSecurityGroupsSelector *v2.Selector `json:"inputSecurityGroupsSelector,omitempty" tf:"-"`
