...
type SelectionInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	NotResourcesRefs []v2.Reference `json:"notResourcesRefs,omitempty" tf:"-"`

	// Selector for a list of Instance in rds to populate notResources.
	// +kubebuilder:validation:Optional
	NotResourcesSelector *v2.Selector `json:"notResourcesSelector,omitempty" tf:"-"`

	// The backup plan ID to be associated with the selection of resources.
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/cluster/backup/v1beta2.Plan
	PlanID *string `json:"planId,omitempty" tf:"plan_id,omitempty"`

	// Reference to a Plan in backup to populate planId.
	// +kubebuilder:validation:Optional
	PlanIDRef *v2.Reference `json:"planIdRef,omitempty" tf:"-"`
