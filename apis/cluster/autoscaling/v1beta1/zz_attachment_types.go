...
type AttachmentInitParameters struct {
	...
	ALBTargetGroupArnRef *v2.Reference `json:"albTargetGroupArnRef,omitempty" tf:"-"`

	// Selector for a LBTargetGroup in elbv2 to populate albTargetGroupArn.
	// +kubebuilder:validation:Optional
	ALBTargetGroupArnSelector *v2.Selector `json:"albTargetGroupArnSelector,omitempty" tf:"-"`
