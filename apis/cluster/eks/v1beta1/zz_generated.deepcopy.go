...
func (in *KubeControllerManagerConfigInitParameters) DeepCopyInto(out *KubeControllerManagerConfigInitParameters) {
	*out = *in
	...
	if in.PodGcControllerConfig != nil {
		in, out := &in.PodGcControllerConfig, &out.PodGcControllerConfig
		*out = make([]PodGcControllerConfigInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KubeControllerManagerConfigObservation) DeepCopyInto(out *KubeControllerManagerConfigObservation) {
	*out = *in
	...
	if in.PodGcControllerConfig != nil {
		in, out := &in.PodGcControllerConfig, &out.PodGcControllerConfig
		*out = make([]PodGcControllerConfigObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KubeControllerManagerConfigParameters) DeepCopyInto(out *KubeControllerManagerConfigParameters) {
	*out = *in
	...
	if in.PodGcControllerConfig != nil {
		in, out := &in.PodGcControllerConfig, &out.PodGcControllerConfig
		*out = make([]PodGcControllerConfigParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodGcControllerConfigInitParameters) DeepCopyInto(out *PodGcControllerConfigInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodGcControllerConfigInitParameters.
func (in *PodGcControllerConfigInitParameters) DeepCopy() *PodGcControllerConfigInitParameters {
	if in == nil {
		return nil
	}
	out := new(PodGcControllerConfigInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodGcControllerConfigObservation) DeepCopyInto(out *PodGcControllerConfigObservation) {
	*out = *in
	if in.TerminatedPodGcThreshold != nil {
		in, out := &in.TerminatedPodGcThreshold, &out.TerminatedPodGcThreshold
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodGcControllerConfigObservation.
func (in *PodGcControllerConfigObservation) DeepCopy() *PodGcControllerConfigObservation {
	if in == nil {
		return nil
	}
	out := new(PodGcControllerConfigObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodGcControllerConfigParameters) DeepCopyInto(out *PodGcControllerConfigParameters) {
	*out = *in
	if in.TerminatedPodGcThreshold != nil {
		in, out := &in.TerminatedPodGcThreshold, &out.TerminatedPodGcThreshold
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodGcControllerConfigParameters.
func (in *PodGcControllerConfigParameters) DeepCopy() *PodGcControllerConfigParameters {
	if in == nil {
		return nil
	}
	out := new(PodGcControllerConfigParameters)
	in.DeepCopyInto(out)
	return out
}
