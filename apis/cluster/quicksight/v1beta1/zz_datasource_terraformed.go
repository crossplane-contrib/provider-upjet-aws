...
func (tr *DataSource) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"credentials[*].credential_pair[*].password": "credentials.credentialPair.passwordSecretRef", "credentials[*].credential_pair[*].username": "credentials.credentialPair.usernameSecretRef"}
}
