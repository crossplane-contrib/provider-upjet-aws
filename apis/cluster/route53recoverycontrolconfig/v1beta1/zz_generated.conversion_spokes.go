...
// ConvertTo converts this SafetyRule to the hub type.
func (tr *SafetyRule) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the SafetyRule type.
func (tr *SafetyRule) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
