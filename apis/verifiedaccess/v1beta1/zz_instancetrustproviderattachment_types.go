...
type InstanceTrustProviderAttachmentInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/verifiedaccess/v1beta1.Instance
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/apis/verifiedaccess/v1beta1.TrustProvider
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/pkg/resource.ExtractResourceID()
