...
type UserStackAssociationParameters struct {
	...
	// Authentication type for the user.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/appstream/v1beta1.User
	...
	// Name of the stack that is associated with the user.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/appstream/v1beta1.Stack
