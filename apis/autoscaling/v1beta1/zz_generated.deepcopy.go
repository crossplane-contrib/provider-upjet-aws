...
func (in *AutoscalingGroupInitParameters) DeepCopyInto(out *AutoscalingGroupInitParameters) {
	*out = *in
	...
	if in.Tag != nil {
		...
		*out = make([]AutoscalingGroupTagInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingGroupObservation) DeepCopyInto(out *AutoscalingGroupObservation) {
	*out = *in
	...
	if in.Tag != nil {
		in, out := &in.Tag, &out.Tag
		*out = make([]AutoscalingGroupTagObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AutoscalingGroupParameters) DeepCopyInto(out *AutoscalingGroupParameters) {
	*out = *in
	...
	if in.Tag != nil {
		in, out := &in.Tag, &out.Tag
		*out = make([]AutoscalingGroupTagParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoscalingGroupTagInitParameters) DeepCopyInto(out *AutoscalingGroupTagInitParameters) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoscalingGroupTagInitParameters.
func (in *AutoscalingGroupTagInitParameters) DeepCopy() *AutoscalingGroupTagInitParameters {
	if in == nil {
		return nil
	}
	out := new(AutoscalingGroupTagInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoscalingGroupTagObservation) DeepCopyInto(out *AutoscalingGroupTagObservation) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoscalingGroupTagObservation.
func (in *AutoscalingGroupTagObservation) DeepCopy() *AutoscalingGroupTagObservation {
	if in == nil {
		return nil
	}
	out := new(AutoscalingGroupTagObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoscalingGroupTagParameters) DeepCopyInto(out *AutoscalingGroupTagParameters) {
	*out = *in
	if in.Key != nil {
		in, out := &in.Key, &out.Key
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoscalingGroupTagParameters.
func (in *AutoscalingGroupTagParameters) DeepCopy() *AutoscalingGroupTagParameters {
	if in == nil {
		return nil
	}
	out := new(AutoscalingGroupTagParameters)
	in.DeepCopyInto(out)
	return out
}
