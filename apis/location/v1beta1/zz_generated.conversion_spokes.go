...
// ConvertTo converts this PlaceIndex to the hub type.
func (tr *PlaceIndex) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the PlaceIndex type.
func (tr *PlaceIndex) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
