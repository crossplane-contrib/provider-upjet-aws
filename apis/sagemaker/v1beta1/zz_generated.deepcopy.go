...
func (in *CanvasAppSettingsModelRegisterSettingsParameters) DeepCopyInto(out *CanvasAppSettingsModelRegisterSettingsParameters) {
	*out = *in
	...
	if in.CrossAccountModelRegisterRoleArnRef != nil {
		in, out := &in.CrossAccountModelRegisterRoleArnRef, &out.CrossAccountModelRegisterRoleArnRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.CrossAccountModelRegisterRoleArnSelector != nil {
		in, out := &in.CrossAccountModelRegisterRoleArnSelector, &out.CrossAccountModelRegisterRoleArnSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Status != nil {
...
func (in *CanvasAppSettingsTimeSeriesForecastingSettingsParameters) DeepCopyInto(out *CanvasAppSettingsTimeSeriesForecastingSettingsParameters) {
	*out = *in
	...
	if in.AmazonForecastRoleArnRef != nil {
		in, out := &in.AmazonForecastRoleArnRef, &out.AmazonForecastRoleArnRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.AmazonForecastRoleArnSelector != nil {
		in, out := &in.AmazonForecastRoleArnSelector, &out.AmazonForecastRoleArnSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.Status != nil {
...
func (in *RStudioServerProDomainSettingsParameters) DeepCopyInto(out *RStudioServerProDomainSettingsParameters) {
	*out = *in
	...
	if in.DomainExecutionRoleArnRef != nil {
		in, out := &in.DomainExecutionRoleArnRef, &out.DomainExecutionRoleArnRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.DomainExecutionRoleArnSelector != nil {
		in, out := &in.DomainExecutionRoleArnSelector, &out.DomainExecutionRoleArnSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.RStudioConnectURL != nil {
...
func (in *SharingSettingsParameters) DeepCopyInto(out *SharingSettingsParameters) {
	*out = *in
	...
	if in.S3KMSKeyIDRef != nil {
		in, out := &in.S3KMSKeyIDRef, &out.S3KMSKeyIDRef
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	if in.S3KMSKeyIDSelector != nil {
		in, out := &in.S3KMSKeyIDSelector, &out.S3KMSKeyIDSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.S3OutputPath != nil {
