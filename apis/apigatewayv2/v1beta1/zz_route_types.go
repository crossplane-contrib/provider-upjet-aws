...
type RouteInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-aws/apis/apigatewayv2/v1beta1.Authorizer
	...
	// +crossplane:generate:reference:extractor=github.com/crossplane-contrib/provider-upjet-aws/config/common/apis.IntegrationIDPrefixed()
