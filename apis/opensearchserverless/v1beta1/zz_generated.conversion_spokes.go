...
// ConvertTo converts this SecurityConfig to the hub type.
func (tr *SecurityConfig) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the SecurityConfig type.
func (tr *SecurityConfig) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
