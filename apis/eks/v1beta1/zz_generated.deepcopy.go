...
func (in *LaunchTemplateParameters) DeepCopyInto(out *LaunchTemplateParameters) {
	*out = *in
	...
	if in.LaunchTemplateIDRefs != nil {
		in, out := &in.LaunchTemplateIDRefs, &out.LaunchTemplateIDRefs
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.LaunchTemplateNameRefs != nil {
		in, out := &in.LaunchTemplateNameRefs, &out.LaunchTemplateNameRefs
		*out = new(v1.Reference)
		(*in).DeepCopyInto(*out)
	}
