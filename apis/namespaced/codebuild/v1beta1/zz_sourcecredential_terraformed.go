...
func (tr *SourceCredential) GetObservation() (map[string]any, error) {
...
func (tr *SourceCredential) SetObservation(obs map[string]any) error {
...
func (tr *SourceCredential) GetParameters() (map[string]any, error) {
...
func (tr *SourceCredential) SetParameters(params map[string]any) error {
...
// GetInitParameters of this SourceCredential
func (tr *SourceCredential) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this SourceCredential
func (tr *SourceCredential) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
