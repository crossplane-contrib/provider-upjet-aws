...
type FunctionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-aws/v2/apis/namespaced/cloudfront/v1beta1.KeyValueStore
	...
	KeyValueStoreAssociationsRefs []v2.NamespacedReference `json:"keyValueStoreAssociationsRefs,omitempty" tf:"-"`

	// Selector for a list of KeyValueStore in cloudfront to populate keyValueStoreAssociations.
	// +kubebuilder:validation:Optional
	KeyValueStoreAssociationsSelector *v2.NamespacedSelector `json:"keyValueStoreAssociationsSelector,omitempty" tf:"-"`
