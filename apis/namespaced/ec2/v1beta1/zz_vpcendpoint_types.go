...
type VPCEndpointInitParameters_2 struct {
	...
	// +kubebuilder:validation:Optional
	ResourceConfigurationArnRef *v2.NamespacedReference `json:"resourceConfigurationArnRef,omitempty" tf:"-"`

	// Selector for a ResourceConfiguration in vpclattice to populate resourceConfigurationArn.
	// +kubebuilder:validation:Optional
	ResourceConfigurationArnSelector *v2.NamespacedSelector `json:"resourceConfigurationArnSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ServiceNetworkArnRef *v2.NamespacedReference `json:"serviceNetworkArnRef,omitempty" tf:"-"`

	// Selector for a ServiceNetwork in vpclattice to populate serviceNetworkArn.
	// +kubebuilder:validation:Optional
	ServiceNetworkArnSelector *v2.NamespacedSelector `json:"serviceNetworkArnSelector,omitempty" tf:"-"`
