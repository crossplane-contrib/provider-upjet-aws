...
type SecurityGroupIngressRuleInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ReferencedSecurityGroupIDRef *v2.NamespacedReference `json:"referencedSecurityGroupIdRef,omitempty" tf:"-"`

	// Selector for a SecurityGroup in ec2 to populate referencedSecurityGroupId.
	// +kubebuilder:validation:Optional
	ReferencedSecurityGroupIDSelector *v2.NamespacedSelector `json:"referencedSecurityGroupIdSelector,omitempty" tf:"-"`
