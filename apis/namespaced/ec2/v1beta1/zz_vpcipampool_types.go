...
type VPCIpamPoolInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	IpamScopeIDRef *v2.NamespacedReference `json:"ipamScopeIdRef,omitempty" tf:"-"`

	// Selector for a VPCIpamScope in ec2 to populate ipamScopeId.
	// +kubebuilder:validation:Optional
	IpamScopeIDSelector *v2.NamespacedSelector `json:"ipamScopeIdSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SourceIpamPoolIDRef *v2.NamespacedReference `json:"sourceIpamPoolIdRef,omitempty" tf:"-"`

	// Selector for a VPCIpamPool in ec2 to populate sourceIpamPoolId.
	// +kubebuilder:validation:Optional
	SourceIpamPoolIDSelector *v2.NamespacedSelector `json:"sourceIpamPoolIdSelector,omitempty" tf:"-"`
