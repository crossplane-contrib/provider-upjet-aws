...
type AppInitParameters struct {
	...
	BasicAuthCredentialsSecretRef *v2.LocalSecretKeySelector `json:"basicAuthCredentialsSecretRef,omitempty" tf:"-"`
	...
	ComputeRoleArnRef *v2.NamespacedReference `json:"computeRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate computeRoleArn.
	// +kubebuilder:validation:Optional
	ComputeRoleArnSelector *v2.NamespacedSelector `json:"computeRoleArnSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	IAMServiceRoleArnRef *v2.NamespacedReference `json:"iamServiceRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate iamServiceRoleArn.
	// +kubebuilder:validation:Optional
	IAMServiceRoleArnSelector *v2.NamespacedSelector `json:"iamServiceRoleArnSelector,omitempty" tf:"-"`
