...
type PlatformApplicationInitParameters struct {
	...
	FailureFeedbackRoleArnRef *v2.NamespacedReference `json:"failureFeedbackRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate failureFeedbackRoleArn.
	// +kubebuilder:validation:Optional
	FailureFeedbackRoleArnSelector *v2.NamespacedSelector `json:"failureFeedbackRoleArnSelector,omitempty" tf:"-"`

	// Application Platform credential. See Credential for type of credential required for platform.
	PlatformCredentialSecretRef v2.LocalSecretKeySelector `json:"platformCredentialSecretRef" tf:"-"`

	// Application Platform principal. See Principal for type of principal required for platform.
	PlatformPrincipalSecretRef *v2.LocalSecretKeySelector `json:"platformPrincipalSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SuccessFeedbackRoleArnRef *v2.NamespacedReference `json:"successFeedbackRoleArnRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate successFeedbackRoleArn.
	// +kubebuilder:validation:Optional
	SuccessFeedbackRoleArnSelector *v2.NamespacedSelector `json:"successFeedbackRoleArnSelector,omitempty" tf:"-"`
