...
// ConvertTo converts this Accelerator to the hub type.
func (tr *Accelerator) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the Accelerator type.
func (tr *Accelerator) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
