...
// GetTerraformResourceType returns Terraform resource type for this Memory
func (mg *Memory) GetTerraformResourceType() string {
	return "aws_bedrockagentcore_memory"
}

// GetConnectionDetailsMapping for this Memory
func (tr *Memory) GetConnectionDetailsMapping() map[string]string {
	return nil
}

// GetObservation of this Memory
func (tr *Memory) GetObservation() (map[string]any, error) {
...
// GetID returns ID of underlying Terraform resource of this Memory
func (tr *Memory) GetID() string {
...
// GetParameters of this Memory
func (tr *Memory) GetParameters() (map[string]any, error) {
...
// SetParameters for this Memory
func (tr *Memory) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Memory
func (tr *Memory) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Memory
func (tr *Memory) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
func (tr *Memory) GetTerraformSchemaVersion() int {
	return 0
}
