...
func (in *IntegrationInitParameters) DeepCopyInto(out *IntegrationInitParameters) {
	*out = *in
	if in.AdditionalEncryptionContext != nil {
		in, out := &in.AdditionalEncryptionContext, &out.AdditionalEncryptionContext
		*out = make(map[string]*string, len(*in))
		for key, val := range *in {
			var outVal *string
			if val == nil {
...
func (in *IntegrationObservation) DeepCopyInto(out *IntegrationObservation) {
	*out = *in
	...
	if in.IntegrationIdentifier != nil {
		in, out := &in.IntegrationIdentifier, &out.IntegrationIdentifier
		*out = new(string)
		**out = **in
	}
	if in.IntegrationName != nil {
