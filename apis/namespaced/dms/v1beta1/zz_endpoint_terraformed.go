...
func (tr *Endpoint) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"kafka_settings[*].sasl_password": "kafkaSettings.saslPasswordSecretRef", "kafka_settings[*].ssl_client_key_password": "kafkaSettings.sslClientKeyPasswordSecretRef", "oracle_settings[*].asm_password": "oracleSettings.asmPasswordSecretRef", "oracle_settings[*].security_db_encryption": "oracleSettings.securityDbEncryptionSecretRef", "password": "passwordSecretRef", "redis_settings[*].auth_password": "redisSettings.authPasswordSecretRef"}
}
