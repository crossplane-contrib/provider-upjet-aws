...
func (mg *VirtualCluster) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this VirtualCluster.
func (mg *VirtualCluster) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *VirtualCluster) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this VirtualCluster.
func (mg *VirtualCluster) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
