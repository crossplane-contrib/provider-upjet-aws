...
type EncryptionAtRestInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	CatalogEncryptionServiceRoleRef *v2.NamespacedReference `json:"catalogEncryptionServiceRoleRef,omitempty" tf:"-"`

	// Selector for a Role in iam to populate catalogEncryptionServiceRole.
	// +kubebuilder:validation:Optional
	CatalogEncryptionServiceRoleSelector *v2.NamespacedSelector `json:"catalogEncryptionServiceRoleSelector,omitempty" tf:"-"`
