...
type AuthenticationConfigurationParameters struct {
	...
	// +kubebuilder:validation:Optional
	CustomAuthenticationCredentialsSecretRef *v2.LocalSecretReference `json:"customAuthenticationCredentialsSecretRef,omitempty" tf:"-"`
...
type AuthorizationCodePropertiesInitParameters struct {
	...
	// Authorization code.
	AuthorizationCodeSecretRef v2.LocalSecretKeySelector `json:"authorizationCodeSecretRef" tf:"-"`
...
type ConnectionParameters struct {
	...
	// +kubebuilder:validation:Optional
	AthenaPropertiesSecretRef *v2.LocalSecretReference `json:"athenaPropertiesSecretRef,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	ConnectionPropertiesSecretRef *v2.LocalSecretReference `json:"connectionPropertiesSecretRef,omitempty" tf:"-"`
...
type Oauth2CredentialsInitParameters struct {
	...
	// JWT token.
	JwtTokenSecretRef *v2.LocalSecretKeySelector `json:"jwtTokenSecretRef,omitempty" tf:"-"`
	...
	UserManagedClientApplicationClientSecretSecretRef *v2.LocalSecretKeySelector `json:"userManagedClientApplicationClientSecretSecretRef,omitempty" tf:"-"`
}
...
type Oauth2PropertiesParameters struct {
	...
	// +kubebuilder:validation:Optional
	TokenURLParametersMapSecretRef *v2.LocalSecretReference `json:"tokenUrlParametersMapSecretRef,omitempty" tf:"-"`
}
...
type PhysicalConnectionRequirementsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AvailabilityZoneRef *v2.NamespacedReference `json:"availabilityZoneRef,omitempty" tf:"-"`

	// Selector for a Subnet in ec2 to populate availabilityZone.
	// +kubebuilder:validation:Optional
	AvailabilityZoneSelector *v2.NamespacedSelector `json:"availabilityZoneSelector,omitempty" tf:"-"`
	...
	// +kubebuilder:validation:Optional
	SecurityGroupIDListRefs []v2.NamespacedReference `json:"securityGroupIdListRefs,omitempty" tf:"-"`

	// Selector for a list of SecurityGroup in ec2 to populate securityGroupIdList.
	// +kubebuilder:validation:Optional
	SecurityGroupIDListSelector *v2.NamespacedSelector `json:"securityGroupIdListSelector,omitempty" tf:"-"`
