...
func (mg *Probe) ResolveReferences( // ResolveReferences of this Probe.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("networkmonitor.aws.m.upbound.io", "v1beta1", "Monitor", "MonitorList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}

		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
			CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.MonitorName),
			Extract:      reference.ExternalName(),
			Namespace:    mg.GetNamespace(),
			Reference:    mg.Spec.ForProvider.MonitorNameRef,
			Selector:     mg.Spec.ForProvider.MonitorNameSelector,
			To:           reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.MonitorName")
	}
	mg.Spec.ForProvider.MonitorName = reference.ToPtrValue(rsp.ResolvedValue)
	mg.Spec.ForProvider.MonitorNameRef = rsp.ResolvedReference
	{
