...
// ConvertTo converts this ContainerService to the hub type.
func (tr *ContainerService) ConvertTo(dstRaw conversion.Hub) error {
...
// ConvertFrom converts from the hub type to the ContainerService type.
func (tr *ContainerService) ConvertFrom(srcRaw conversion.Hub) error {
	spokeVersion := tr.GetObjectKind().GroupVersionKind().Version
