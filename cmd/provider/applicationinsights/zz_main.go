...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_applicationinsights(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_applicationinsights(mgr, o), "Cannot setup namespaced AWS controllers")
