...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_elbv2(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_elbv2(mgr, o), "Cannot setup namespaced AWS controllers")
