...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_monolith(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_monolith(mgr, o), "Cannot setup namespaced AWS controllers")
