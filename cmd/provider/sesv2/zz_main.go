...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_sesv2(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_sesv2(mgr, o), "Cannot setup namespaced AWS controllers")
