...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_wafv2(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_wafv2(mgr, o), "Cannot setup namespaced AWS controllers")
