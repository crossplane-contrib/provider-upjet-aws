...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_waf(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_waf(mgr, o), "Cannot setup namespaced AWS controllers")
