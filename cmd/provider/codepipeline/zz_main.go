...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_codepipeline(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_codepipeline(mgr, o), "Cannot setup namespaced AWS controllers")
