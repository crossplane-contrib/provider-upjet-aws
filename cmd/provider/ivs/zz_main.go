...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_ivs(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_ivs(mgr, o), "Cannot setup namespaced AWS controllers")
