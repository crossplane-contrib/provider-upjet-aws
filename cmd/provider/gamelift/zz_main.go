...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_gamelift(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_gamelift(mgr, o), "Cannot setup namespaced AWS controllers")
