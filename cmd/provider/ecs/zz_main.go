...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_ecs(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_ecs(mgr, o), "Cannot setup namespaced AWS controllers")
