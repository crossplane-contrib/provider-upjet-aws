...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_cloud9(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_cloud9(mgr, o), "Cannot setup namespaced AWS controllers")
