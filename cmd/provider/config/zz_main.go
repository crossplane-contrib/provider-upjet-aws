...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_config(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_config(mgr, o), "Cannot setup namespaced AWS controllers")
