...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_route53(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_route53(mgr, o), "Cannot setup namespaced AWS controllers")
