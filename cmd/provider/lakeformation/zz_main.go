...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_lakeformation(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_lakeformation(mgr, o), "Cannot setup namespaced AWS controllers")
