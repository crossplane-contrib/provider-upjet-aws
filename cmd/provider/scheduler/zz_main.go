...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_scheduler(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_scheduler(mgr, o), "Cannot setup namespaced AWS controllers")
