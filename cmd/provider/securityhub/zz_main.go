...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_securityhub(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_securityhub(mgr, o), "Cannot setup namespaced AWS controllers")
