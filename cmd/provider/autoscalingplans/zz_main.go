...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_autoscalingplans(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_autoscalingplans(mgr, o), "Cannot setup namespaced AWS controllers")
