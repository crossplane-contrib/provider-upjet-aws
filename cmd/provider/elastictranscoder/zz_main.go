...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_elastictranscoder(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_elastictranscoder(mgr, o), "Cannot setup namespaced AWS controllers")
