...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_s3control(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_s3control(mgr, o), "Cannot setup namespaced AWS controllers")
