...
func main() {
	...
	kingpin.FatalIfError(clustercontroller.Setup_osis(mgr, o), "Cannot setup cluster-scoped AWS controllers")
	kingpin.FatalIfError(namespacedcontroller.Setup_osis(mgr, o), "Cannot setup namespaced AWS controllers")
