...
// SetupGated_emrserverless creates all controllers with the supplied logger and adds them to
...
// SetupWebhookWithManager_emrserverless registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_emrserverless(mgr ctrl.Manager) error {
