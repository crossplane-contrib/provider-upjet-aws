...
// SetupWebhookWithManager_servicediscovery registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_servicediscovery(mgr ctrl.Manager) error {
