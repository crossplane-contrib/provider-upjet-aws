...
// SetupWebhookWithManager_transcribe registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_transcribe(mgr ctrl.Manager) error {
