...
// SetupWebhookWithManager_autoscalingplans registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_autoscalingplans(mgr ctrl.Manager) error {
