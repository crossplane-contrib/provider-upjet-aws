...
// SetupWebhookWithManager_cloudsearch registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_cloudsearch(mgr ctrl.Manager) error {
