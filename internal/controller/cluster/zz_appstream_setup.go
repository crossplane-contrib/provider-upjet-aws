...
// SetupWebhookWithManager_appstream registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_appstream(mgr ctrl.Manager) error {
