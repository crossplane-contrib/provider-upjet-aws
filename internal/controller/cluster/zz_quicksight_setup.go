...
// SetupWebhookWithManager_quicksight registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_quicksight(mgr ctrl.Manager) error {
