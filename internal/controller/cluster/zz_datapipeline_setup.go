...
// SetupWebhookWithManager_datapipeline registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_datapipeline(mgr ctrl.Manager) error {
