...
// SetupWebhookWithManager_kinesisanalytics registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_kinesisanalytics(mgr ctrl.Manager) error {
