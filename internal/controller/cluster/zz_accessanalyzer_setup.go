...
// SetupWebhookWithManager_accessanalyzer registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_accessanalyzer(mgr ctrl.Manager) error {
