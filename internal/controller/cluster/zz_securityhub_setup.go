...
// SetupWebhookWithManager_securityhub registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_securityhub(mgr ctrl.Manager) error {
