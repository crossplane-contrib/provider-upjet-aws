...
// SetupWebhookWithManager_dataexchange registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_dataexchange(mgr ctrl.Manager) error {
