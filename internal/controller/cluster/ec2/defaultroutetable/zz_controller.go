...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.DefaultRouteTable_GroupVersionKind)))
	...
	// register webhooks for the kind v1beta1.DefaultRouteTable if they're enabled.
	if o.StartWebhooks {
