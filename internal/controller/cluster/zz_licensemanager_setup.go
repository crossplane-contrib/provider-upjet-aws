...
// SetupWebhookWithManager_licensemanager registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_licensemanager(mgr ctrl.Manager) error {
