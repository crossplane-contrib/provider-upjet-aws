...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewNoForkConnector(mgr.GetClient(), o.SetupFn, o.Provider.Resources["aws_db_proxy_default_target_group"], o.OperationTrackerStore, tjcontroller.WithNoForkLogger(o.Logger),
			tjcontroller.WithNoForkMetricRecorder(metrics.NewMetricRecorder(v1beta1.ProxyDefaultTargetGroup_GroupVersionKind, mgr, o.PollInterval)))),
