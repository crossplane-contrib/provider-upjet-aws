...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(tjcontroller.NewNoForkConnector(mgr.GetClient(), o.SetupFn, o.Provider.Resources["aws_efs_mount_target"], tjcontroller.WithNoForkLogger(o.Logger),
			tjcontroller.WithNoForkConnectorEventHandler(eventHandler),
			tjcontroller.WithNoForkMetricRecorder(metrics.NewMetricRecorder(v1beta1.MountTarget_GroupVersionKind, mgr, o.PollInterval)))),
