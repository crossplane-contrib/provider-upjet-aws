...
// SetupWebhookWithManager_appautoscaling registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_appautoscaling(mgr ctrl.Manager) error {
