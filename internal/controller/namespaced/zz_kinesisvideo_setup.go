...
import (
	...
	stream "github.com/upbound/provider-aws/v2/internal/controller/namespaced/kinesisvideo/stream"
)
...
// SetupGated_kinesisvideo creates all controllers with the supplied logger and adds them to
