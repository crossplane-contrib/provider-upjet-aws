...
// SetupWebhookWithManager_codeguruprofiler registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_codeguruprofiler(mgr ctrl.Manager) error {
