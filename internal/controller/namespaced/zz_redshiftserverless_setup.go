...
// SetupWebhookWithManager_redshiftserverless registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_redshiftserverless(mgr ctrl.Manager) error {
