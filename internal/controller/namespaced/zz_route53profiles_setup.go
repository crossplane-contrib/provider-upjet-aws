...
// SetupWebhookWithManager_route53profiles registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_route53profiles(mgr ctrl.Manager) error {
