...
// SetupWebhookWithManager_s3control registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_s3control(mgr ctrl.Manager) error {
