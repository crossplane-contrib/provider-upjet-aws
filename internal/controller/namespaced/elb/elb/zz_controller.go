...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.ELB_GroupVersionKind)))
	...
	// register webhooks for the kind v1beta1.ELB if they're enabled.
	if o.StartWebhooks {
