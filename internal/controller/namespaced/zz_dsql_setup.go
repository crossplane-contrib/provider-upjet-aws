...
// SetupWebhookWithManager_dsql registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_dsql(mgr ctrl.Manager) error {
