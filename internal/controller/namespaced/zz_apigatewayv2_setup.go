...
import (
	...
	authorizer "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/authorizer"
	deployment "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/deployment"
	domainname "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/domainname"
	integration "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/integration"
	integrationresponse "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/integrationresponse"
	model "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/model"
	...
	stage "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/stage"
	vpclink "github.com/upbound/provider-aws/internal/controller/namespaced/apigatewayv2/vpclink"
)
