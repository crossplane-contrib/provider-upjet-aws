...
import (
	...
	v1beta1 "github.com/upbound/provider-aws/v2/apis/namespaced/timestreaminfluxdb/v1beta1"
	"github.com/upbound/provider-aws/v2/internal/clients"
	features "github.com/upbound/provider-aws/v2/internal/features"
)

// SetupWebhookWithManager registers the conversion webhook for DBCluster.
func SetupWebhookWithManager(mgr ctrl.Manager) error {
	if err := ctrl.NewWebhookManagedBy(mgr, &v1beta1.DBCluster{}).
		Complete(); err != nil {
		return errors.Wrap(err, "cannot register webhook for the kind v1beta1.DBCluster")
	}
	return nil
}

// SetupGated adds a controller that reconciles DBCluster managed resources.
func SetupGated(mgr ctrl.Manager, o tjcontroller.Options) error {
	o.Options.Gate.Register(func() {
		if err := Setup(mgr, o); err != nil {
			mgr.GetLogger().Error(err, "unable to setup reconciler", "gvk", v1beta1.DBCluster_GroupVersionKind.String())
		}
	}, v1beta1.DBCluster_GroupVersionKind)
	return nil
}

// Setup adds a controller that reconciles DBCluster managed resources.
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	name := managed.ControllerName(v1beta1.DBCluster_GroupVersionKind.String())
	...
	eventHandler := handler.NewEventHandler(handler.WithDefaultRateLimiter(rl), handler.WithLogger(o.Logger.WithValues("gvk", v1beta1.DBCluster_GroupVersionKind)))
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginFrameworkAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["aws_timestreaminfluxdb_db_cluster"],
				...
				tjcontroller.WithTerraformPluginFrameworkAsyncMetricRecorder(metrics.NewMetricRecorder(v1beta1.DBCluster_GroupVersionKind, mgr, o.PollInterval)),
	...
	if o.MetricOptions != nil && o.MetricOptions.MRStateMetrics != nil {
		stateMetricsRecorder := statemetrics.NewMRStateRecorder(
			mgr.GetClient(), o.Logger, o.MetricOptions.MRStateMetrics, &v1beta1.DBClusterList{}, o.MetricOptions.PollStateMetricInterval,
		)
		if err := mgr.Add(stateMetricsRecorder); err != nil {
			return errors.Wrap(err, "cannot register MR state metrics recorder for kind v1beta1.DBClusterList")
		}
	}

	r := managed.NewReconciler(mgr, xpresource.ManagedKind(v1beta1.DBCluster_GroupVersionKind), opts...)
	...
	return ctrl.NewControllerManagedBy(mgr).
		...
		Watches(&v1beta1.DBCluster{}, eventHandler).
		Complete(
