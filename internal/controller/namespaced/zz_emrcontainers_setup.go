...
// SetupWebhookWithManager_emrcontainers registers conversion webhooks for all resource kinds in the group.
func SetupWebhookWithManager_emrcontainers(mgr ctrl.Manager) error {
